...
export async function analyzeIndicator(
  ...
  if (!response.ok) {
    const error = await response.json();
    throw new Error(error.detail || "Failed to analyze indicator");
  }
 ...
 */
export async function importApiSource(source: string): Promise<ImportSourceResponse> {
 ...
 */
export async function startFullCatalogImport(source: string): Promise<FullCatalogImportProgressResponse> {
 ...
 */
export async function rebuildFullCatalogCache(source: string): Promise<FullCatalogImportProgressResponse> {
 ...
 */
export async function getFullCatalogImportProgress(source: string): Promise<FullCatalogImportProgressResponse> {
